...
## [2.21.0](https://github.com/yedayak/bash-completion/compare/2.20.0...2.21.0) (2026-03-26)


### Features

* **_comp_backup_glob:** add zsync .zs-old ([a342d3a](https://github.com/yedayak/bash-completion/commit/a342d3a48039d896113f7a8c876f74890f417185))
* **_comp_compgen_help:** enhance for smartctl ([2f7513c](https://github.com/yedayak/bash-completion/commit/2f7513c6398b0d3fc26afd4d4cfe752ec40015c4))
* **_comp_compgen:** support `-P prefix` with adjusted `cur` ([b6d4335](https://github.com/yedayak/bash-completion/commit/b6d4335db507939bf198dd49429da957c816f341))
* **_comp_compgen:** support `-P prefix` with auto-adjusted `cur` ([6da0ae8](https://github.com/yedayak/bash-completion/commit/6da0ae8064a32a56deb719bff3d7d92ce32bd746))
* **_filedir:** add `-f` to manually suffix / to directory names ([13868b8](https://github.com/yedayak/bash-completion/commit/13868b8430a45e0c9c2db836d3227c95f1aadc07))
* **_filedir:** add tests with `_comp_compgen -C` ([d99f06a](https://github.com/yedayak/bash-completion/commit/d99f06a1cbd43db33d6f747ce32ccb2d0a9a130c))
* ***sum:** handle more common checksum filenames ([6cc313f](https://github.com/yedayak/bash-completion/commit/6cc313feaa109f76199e649a2cbf72da829ae9d5))
* 3rd party fallback completion loaders for diffoci, gomarklint, and mado ([5e9ab5a](https://github.com/yedayak/bash-completion/commit/5e9ab5ad7bc8edd64df70c3892bf4c002b757303))
* **aclocal,automake:** support versioned 1.17 executables ([94bbb3a](https://github.com/yedayak/bash-completion/commit/94bbb3a1b6fafeac96c27e1899dd5efc920a6a89))
* add (many) more 3rd party fallback completion loaders ([47f46c2](https://github.com/yedayak/bash-completion/commit/47f46c21c4f5c9055b9b726bb845b56d6154990d))
* add even more 3rd party fallback completion loaders ([520bb07](https://github.com/yedayak/bash-completion/commit/520bb07dc6eb10a48bb95f4f4a6fd4cc2cddc081))
* **aptitude:** update sub-commands ([4ac918f](https://github.com/yedayak/bash-completion/commit/4ac918f075c71e54753e90b8d1fd87871ca4a08f))
* **argc:** add 3rd party fallback completion loader ([f0c3b59](https://github.com/yedayak/bash-completion/commit/f0c3b59fd21edb99f6aec83043eb4ce0eaa64d29))
* **asdf:** add 3rd-party fallback completion loader for "asdf" ([cb9303f](https://github.com/yedayak/bash-completion/commit/cb9303f5b121ea4769e20b3bb44959c4a2214661))
* associate .ogx and .oga with relevant programs ([0a13be1](https://github.com/yedayak/bash-completion/commit/0a13be1f6576ee4977552379e11157073b4e841b))
* **bombadil:** add 3rd party fallback completion loader ([90ef9a2](https://github.com/yedayak/bash-completion/commit/90ef9a215521f14e0c66dd10d530c14648e7ecf6))
* **brave:** alias to chromium ([928c74f](https://github.com/yedayak/bash-completion/commit/928c74fc7a41e0fd1322cd6e583c693daeca76fe))
* **bsdtar:** support .apk, .ipa and .hap ([bc10b93](https://github.com/yedayak/bash-completion/commit/bc10b93e5bc16ea3c5e20d26de9eabcd9ba7d97f))
* **chamber:** add 3rd party fallback completion loader ([d6f2798](https://github.com/yedayak/bash-completion/commit/d6f2798960b4597ee40206e80a140cfc40e85b92))
* **changie:** add 3rd party fallback completion loader ([5268e0b](https://github.com/yedayak/bash-completion/commit/5268e0bd7700edd956ea3566216b3536cc7cbdfd))
* **colima:** add 3rd party fallback completion loader ([55a75aa](https://github.com/yedayak/bash-completion/commit/55a75aae8a21b11d65eef27e115d853a2e24819a))
* **conform:** add 3rd party fallback completion loader ([676c062](https://github.com/yedayak/bash-completion/commit/676c0629ee1f7fdba5f480387b54b708cb211b43))
* **conftest:** add 3rd party fallback completion loader ([123c8d5](https://github.com/yedayak/bash-completion/commit/123c8d599d1b818a3e775ab16854fee7ccb62f40))
* **container-structure-test:** add 3rd party fallback completion loader ([42d9241](https://github.com/yedayak/bash-completion/commit/42d9241eee14f8cbbf7e71df1ba8d7cb56badbfa))
* **coreutils:** update for newer GNU coreutils ([#1457](https://github.com/yedayak/bash-completion/issues/1457)) ([594de4e](https://github.com/yedayak/bash-completion/commit/594de4e157d1399c97da99f20e544438e820dff1))
* **crane,gcrane,krane:** add 3rd party fallback completion loaders ([24918db](https://github.com/yedayak/bash-completion/commit/24918dbca1d0adfee7b88c761d4a48f36061c864))
* **crictl:** add 3rd party fallback completion loader ([7823df8](https://github.com/yedayak/bash-completion/commit/7823df8716e32486d83a3ece16f688bca011191b))
* **ctlptl:** add 3rd party fallback completion loader ([c3784cc](https://github.com/yedayak/bash-completion/commit/c3784cc41acf1bf984e4279ba34fb4cdfb13e61c))
* **cue:** add 3rd party fallback completion loader ([b9b56e0](https://github.com/yedayak/bash-completion/commit/b9b56e031a1902a76b9a6fb55ce3bd17ccce413f))
* **curl:** Complete IP addresses for --interface ([0ea21b9](https://github.com/yedayak/bash-completion/commit/0ea21b987a1ffeec3d0a2d4c630bfcd20e19b87c))
* **curl:** more option argument (non-)completions ([5099cef](https://github.com/yedayak/bash-completion/commit/5099cef13ff71d166243ef66777620d0f8e714b6))
* **dagger:** add 3rd party fallback completion loader ([fb50c08](https://github.com/yedayak/bash-completion/commit/fb50c0860507518bec63f9b42d0116af5a9cd4b3))
* **dapr:** add 3rd party fallback completion loader ([12b91f1](https://github.com/yedayak/bash-completion/commit/12b91f11ab9dd3335222099c7d02462375829181))
* **dasel:** add 3rd party fallback completion loader ([6c85159](https://github.com/yedayak/bash-completion/commit/6c8515988c6cc9523c1798e64a99762a1c76fc5e))
* **deck:** add 3rd party fallback completion loader ([254f76a](https://github.com/yedayak/bash-completion/commit/254f76a30838f624326346737c7b434fd20eac78))
* **delta:** add 3rd party fallback completion loader ([164852f](https://github.com/yedayak/bash-completion/commit/164852f9555d8fcb1959f06f2cbaed75a24ab6d7))
* **depot:** add 3rd party fallback completion loader ([ba56206](https://github.com/yedayak/bash-completion/commit/ba5620612b7e7c4ec2ca57ef92cbaa599fc42814))
* **devspace:** add 3rd party fallback completion loader ([ad11337](https://github.com/yedayak/bash-completion/commit/ad113374f6808a9edd304055bbadc383b1cb0e1e))
* **diffoci:** add 3rd party fallback completion loader ([5d5f997](https://github.com/yedayak/bash-completion/commit/5d5f99747fde1e93d39bd458f0be5d12941c4b59))
* **dive:** add 3rd party fallback completion loader ([f817cca](https://github.com/yedayak/bash-completion/commit/f817ccabe8db631b96d4b84784bb0109339eebae))
* **driftctl:** add 3rd party fallback completion loader ([fffafbc](https://github.com/yedayak/bash-completion/commit/fffafbc83720d49bc4c9531d712e583dafef8ee6))
* **dyff:** add 3rd party fallback completion loader ([3a37c60](https://github.com/yedayak/bash-completion/commit/3a37c60699fa34a1a81afb654cbd79f7f5d94fa5))
* **esc:** add 3rd party fallback completion loader ([48a2811](https://github.com/yedayak/bash-completion/commit/48a281172efcced5ee688e0e5c93530a0fed17a3))
* **flux:** add 3rd party fallback completion loader ([ddd108b](https://github.com/yedayak/bash-completion/commit/ddd108b34ccc25eaa889c79ef23d2c36af30aada))
* **free:** new completion ([f82ac04](https://github.com/yedayak/bash-completion/commit/f82ac04a5ec3bd6d1832aab62d06e44232e0e2fd))
* **fsnotifywait,fsnotifywatch:** new, alias to inotifywait ([8e8dacc](https://github.com/yedayak/bash-completion/commit/8e8dacc78a5d1a3bc7638353e9ba6d9523a5b6b7))
* **furyctl:** add 3rd party fallback completion loader ([01ee387](https://github.com/yedayak/bash-completion/commit/01ee387a8d5181ebd6594a481405d960942d4f24))
* **fx:** add 3rd party fallback completion loader ([86b838c](https://github.com/yedayak/bash-completion/commit/86b838c7028c5c2bea8c6664f4f25aaee17b4d9c))
* **ghorg:** add 3rd party fallback completion loader ([7313401](https://github.com/yedayak/bash-completion/commit/731340147be6a66b1a7506df6ffeccdc2aaad680))
* **gitconfig:** add 3rd party fallback completion loader ([1fe9904](https://github.com/yedayak/bash-completion/commit/1fe99041ab155648f77b3f3c67fa85a7247cddb9))
* **gitleaks:** add 3rd party fallback completion loader ([a642fc8](https://github.com/yedayak/bash-completion/commit/a642fc87fb41e78a4cb3747afd325004cb33d184))
* **gitsign:** add 3rd party fallback completion loader ([635d734](https://github.com/yedayak/bash-completion/commit/635d734ba8adcafb710402c79e105de7a73e986d))
* **glab:** add 3rd party fallback completion loader ([c298dcf](https://github.com/yedayak/bash-completion/commit/c298dcfd2f5a8a67ada2b48723701ed0941383df))
* **glances:** add 3rd party fallback completion loader ([4218596](https://github.com/yedayak/bash-completion/commit/421859654c94c9864c8d93ca539295024f480504))
* **glen:** add 3rd party fallback completion loader ([89ad58f](https://github.com/yedayak/bash-completion/commit/89ad58f63def8459bfc13f3072ed94d33a705473))
* **glow:** add 3rd party fallback completion loader ([8c3166b](https://github.com/yedayak/bash-completion/commit/8c3166bbdcfc8fc273c0e88c09c4cf92eb3f3148))
* **gomarklint:** add 3rd party fallback completion loader ([162dcf1](https://github.com/yedayak/bash-completion/commit/162dcf1855cb539bd74fc87bfa3b2ad35d504e81))
* **gopass:** add 3rd party fallback completion loader ([81c6273](https://github.com/yedayak/bash-completion/commit/81c62737cb938fb21237d1c992c513a143a8b0e4))
* **grype:** add 3rd party fallback completion loader ([a1b3831](https://github.com/yedayak/bash-completion/commit/a1b3831c8a5cffedd9295fb5ab5c9418a3089945))
* **helmfile:** add 3rd party fallback completion loader ([3dec92b](https://github.com/yedayak/bash-completion/commit/3dec92b0f7f0a7f34c5540c3b2983938d2b64bca))
* **hostctl:** add 3rd party fallback completion loader ([25700b6](https://github.com/yedayak/bash-completion/commit/25700b615424cd01974c81a5d2dbca84ac45f5a2))
* **imgpkg:** add 3rd party fallback completion loader ([c7da7bb](https://github.com/yedayak/bash-completion/commit/c7da7bbc0c91d5c1fbbcd56407a908d54ef27f7e))
* **ip:** Check /usr/share config path ([45530b0](https://github.com/yedayak/bash-completion/commit/45530b095fd0af2d4e6b2430f2eb2558c6ef658c))
* **just:** add 3rd party fallback completion loader ([de59a20](https://github.com/yedayak/bash-completion/commit/de59a2070334af9d89aebbc1bd47d214a15b5d92))
* **jwt:** add 3rd party fallback completion loader ([03229b3](https://github.com/yedayak/bash-completion/commit/03229b3bde066f281e5223302ee774f4f9870caa))
* **k0sctl:** add 3rd party fallback completion loader ([9a78b89](https://github.com/yedayak/bash-completion/commit/9a78b899b093b0b599f389ac1fa1c909d5458de8))
* **k3d:** add 3rd party fallback completion loader ([9bb60a3](https://github.com/yedayak/bash-completion/commit/9bb60a3d527746808b946d9113ecd2f6de61ae5e))
* **k3sup:** add 3rd party fallback completion loader ([c58ae25](https://github.com/yedayak/bash-completion/commit/c58ae258383694488a726a58a5425968bfcf38ae))
* **k6:** add 3rd party fallback completion loader ([05ec5d8](https://github.com/yedayak/bash-completion/commit/05ec5d8facaa7ae89b06e8ea583115b0de810d5d))
* **k9s:** add 3rd party fallback completion loader ([cb5005c](https://github.com/yedayak/bash-completion/commit/cb5005c7e0922ede9b25b7b2d8ce28844a92b97c))
* **kafkactl:** add 3rd party fallback completion loader ([baeb267](https://github.com/yedayak/bash-completion/commit/baeb267176894a962f942fa044938ee62e9b7564))
* **kapp:** add 3rd party fallback completion loader ([dd6c685](https://github.com/yedayak/bash-completion/commit/dd6c68575690715ed7e970914c8a210274f75c97))
* **kconf:** add 3rd party fallback completion loader ([9609b50](https://github.com/yedayak/bash-completion/commit/9609b50be2a875260ba7e94f40b600ceb7db069d))
* **kind:** add 3rd party fallback completion loader ([bf54a1f](https://github.com/yedayak/bash-completion/commit/bf54a1fe40b3af77f3a538b97be8a50ccf74a2d5))
* **ko:** add 3rd party fallback completion loader ([ae1b9a2](https://github.com/yedayak/bash-completion/commit/ae1b9a283ec2dcc08590573a022446fea0e9a552))
* **kompose:** add 3rd party fallback completion loader ([e291111](https://github.com/yedayak/bash-completion/commit/e29111166e339ce38bbb7cb0ba58ae84d249dd5c))
* **kops:** add 3rd party fallback completion loader ([6dad3f5](https://github.com/yedayak/bash-completion/commit/6dad3f5118730f97a66558269e5d19a78b73d06f))
* **kube-capacity:** add 3rd party fallback completion loader ([ce05e4c](https://github.com/yedayak/bash-completion/commit/ce05e4c6f0cb0a8903904b91ed5dd2e01c9d4d64))
* **kube-linter:** add 3rd party fallback completion loader ([37d645d](https://github.com/yedayak/bash-completion/commit/37d645df5efe28e333292098f8ba5dac9c7acd49))
* **kubebuilder:** add 3rd party fallback completion loader ([1d6650c](https://github.com/yedayak/bash-completion/commit/1d6650c114072254bae56b9a65cac54d0c3cc052))
* **kubecm:** add 3rd party fallback completion loader ([dbd94cb](https://github.com/yedayak/bash-completion/commit/dbd94cb85762d1c1195ef28752a3c12e858e2d56))
* **kubectl-argo-rollouts:** add 3rd party fallback completion loader ([0282c1e](https://github.com/yedayak/bash-completion/commit/0282c1e06cf179a7b8b9ad59ce24b274f20336da))
* **kubectl-kuttl:** add 3rd party fallback completion loader ([a9b0084](https://github.com/yedayak/bash-completion/commit/a9b00849f5f14b6bb89e2cef066990eeef6cc419))
* **kubelogin:** add 3rd party fallback completion loader ([e130911](https://github.com/yedayak/bash-completion/commit/e13091122c4fa0b77f9782dcc38d7252cfbdaa38))
* **kubemqctl:** add 3rd party fallback completion loader ([4c9798d](https://github.com/yedayak/bash-completion/commit/4c9798d26247bd96f457c9277d48c39ecd1428b4))
* **kubesec:** add 3rd party fallback completion loader ([19c6c67](https://github.com/yedayak/bash-completion/commit/19c6c67a3a70c6697ff6b5022986f75110d06626))
* **kubeshark:** add 3rd party fallback completion loader ([fdd3c4a](https://github.com/yedayak/bash-completion/commit/fdd3c4aa7fb33d17f32861317ad3eaf3f8d8274a))
* **kubespy:** add 3rd party fallback completion loader ([7aa7ac1](https://github.com/yedayak/bash-completion/commit/7aa7ac18d11e3814fd517e4f1f2c1c62909fedd7))
* **kustomize:** add 3rd party fallback completion loader ([b780527](https://github.com/yedayak/bash-completion/commit/b7805270088483b3b8e8498400ea8645ad916c83))
* **kyverno:** add 3rd party fallback completion loader ([2ca5975](https://github.com/yedayak/bash-completion/commit/2ca59759892423db45a93972e91215fc5af16b1e))
* **limactl:** add 3rd party fallback completion loader ([01bafcb](https://github.com/yedayak/bash-completion/commit/01bafcb87c74e76d87c73efbe7a3c00f387ff291))
* **mado:** add 3rd party fallback completion loader ([4e4f6be](https://github.com/yedayak/bash-completion/commit/4e4f6be07ad29d98a4680d44472f42094036f52f))
* **mago:** add 3rd party fallback completion loader ([97c4c49](https://github.com/yedayak/bash-completion/commit/97c4c494f414363c66dd0e7e2f3485d65f54e879))
* **melange:** add 3rd party fallback completion loader ([6d4ad73](https://github.com/yedayak/bash-completion/commit/6d4ad73420506be2d6b69f5e9eb6005eb8bff865))
* **minishift:** add 3rd party fallback completion loader ([d8d3fe1](https://github.com/yedayak/bash-completion/commit/d8d3fe1c3f4229ef6692de4d15653b6de15d39e1))
* **mockery:** add 3rd party fallback completion loader ([c79bc1c](https://github.com/yedayak/bash-completion/commit/c79bc1c772f3a61ee8a453303b2ab7c7c45bb28f))
* **nload:** new completion ([e700ae7](https://github.com/yedayak/bash-completion/commit/e700ae78d7f5c1f4ddd5cdf778ea1a0c6bf1798f))
* **notation:** add 3rd party fallback completion loader ([cbaef0f](https://github.com/yedayak/bash-completion/commit/cbaef0fd0790da8f0db22dc75d68b284ffa3854c))
* **nova:** add 3rd party fallback completion loader ([ce7b092](https://github.com/yedayak/bash-completion/commit/ce7b0927d84b596c2064f245edcef3ff3fb2b287))
* **odo:** add 3rd party fallback completion loader ([48f00ce](https://github.com/yedayak/bash-completion/commit/48f00cec63473f6ddb3ed2d34b0c7a20e7b0f518))
* **opa:** add 3rd party fallback completion loader ([e0b4c7f](https://github.com/yedayak/bash-completion/commit/e0b4c7f5acf68e1365ee0231f61a971825239817))
* **openssl:** Complete encryption algos for `enc` ([01b3aa2](https://github.com/yedayak/bash-completion/commit/01b3aa2fadd01ead3e79dd449d5767334bc2543b))
* **openssl:** show only standard commands ([6fb0827](https://github.com/yedayak/bash-completion/commit/6fb082718d86163ca2a3310d91c3491e72253cc7))
* **oras:** add 3rd party fallback completion loader ([cb5d152](https://github.com/yedayak/bash-completion/commit/cb5d152e9d79e752f62a3764e00fface687b4ea7))
* **pitchfork:** add 3rd party fallback completion loader ([538344e](https://github.com/yedayak/bash-completion/commit/538344e8c1230d977237abb3ebaed1d9acbaaad6))
* **pluto:** add 3rd party fallback completion loader ([f519f21](https://github.com/yedayak/bash-completion/commit/f519f2184fda8b81a4759e52856c21e96474d338))
* **pnpm:** add 3rd party fallback completion loader ([44804ae](https://github.com/yedayak/bash-completion/commit/44804ae89fd032af6058cd8307080aa759a0a73d))
* **popeye:** add 3rd party fallback completion loader ([23140b2](https://github.com/yedayak/bash-completion/commit/23140b225fee9febe4a355c382c8625d2e484685))
* **pydoc:** support versioned 3.13..15 executables ([bd60b26](https://github.com/yedayak/bash-completion/commit/bd60b26e6fb3c774c959ad3e7f8558485b60c405))
* **pytest:** complete --asyncio-mode arg ([6b27125](https://github.com/yedayak/bash-completion/commit/6b27125ffa965ad6b93ce82788f973234ea84a67))
* **pytest:** complete --record-mode arg ([d14cf0d](https://github.com/yedayak/bash-completion/commit/d14cf0d1613d8940e0b4bdc7b73eb2d904198ef4))
* **python,pyvenv:** support versioned 3.14 and .15 executables ([72a2e47](https://github.com/yedayak/bash-completion/commit/72a2e479cfe743ab870bf479adb3a3c27eb7e64f))
* **regal:** add 3rd party fallback completion loader ([a18e23c](https://github.com/yedayak/bash-completion/commit/a18e23cd90c6f4e3ea1d6213d6d864eead772110))
* **regctl:** add 3rd party fallback completion loader ([b3eec76](https://github.com/yedayak/bash-completion/commit/b3eec7618c39b9a76013defe6a1e08f786e45422))
* **release-plz:** add 3rd party fallback completion loader ([c3c4066](https://github.com/yedayak/bash-completion/commit/c3c406674e92b4503b26202764de9da87fb3c41c))
* **rustic:** add 3rd party fallback completion loader ([8ec77d0](https://github.com/yedayak/bash-completion/commit/8ec77d0f530bfdd04b610f8a9ef2a0fee76a5bfb))
* **sentry-cli:** add 3rd party fallback completion loader ([7b3ac92](https://github.com/yedayak/bash-completion/commit/7b3ac928b94ae12000017e8e29f0bccaa35601f8))
* **shtab:** add 3rd party fallback completion loader ([90162b0](https://github.com/yedayak/bash-completion/commit/90162b0a6cb31fe32acfe6af5079c9c4454dc8fb))
* **shtab:** add 3rd party fallback completion loader ([20f5622](https://github.com/yedayak/bash-completion/commit/20f5622fb602fd0dc6c1d8921f2d061c5fd9eaf8))
* **sinker:** add 3rd party fallback completion loader ([69567f7](https://github.com/yedayak/bash-completion/commit/69567f7ed78db8b94766632296af8d897a5960ed))
* **slsa-verifier:** add 3rd party fallback completion loader ([ac0bb34](https://github.com/yedayak/bash-completion/commit/ac0bb34d948e1690c639a1f9ae666d426faec6b3))
* **smartctl:** update for smartmontools 7.5 ([31675a3](https://github.com/yedayak/bash-completion/commit/31675a39a2d72e7f77253c41f93c9c9ad7736ab1))
* **sopstool:** add 3rd party fallback completion loader ([4c17fa0](https://github.com/yedayak/bash-completion/commit/4c17fa0c50867903fad137718f88a6850629a107))
* **spacectl:** add 3rd party fallback completion loader ([542fb01](https://github.com/yedayak/bash-completion/commit/542fb01d9c23dbc0aaac60e6f0f01fc2389afe2a))
* **ssh-keygen:** -M arg completion ([b13bf99](https://github.com/yedayak/bash-completion/commit/b13bf99ac8f765fde880b464e41e1e64b1f1161d))
* **ssh-keygen:** -Z argument completion ([c763d52](https://github.com/yedayak/bash-completion/commit/c763d52dfd8934c59e8fa7f8d95142444d08dc8e))
* **ssh-keygen:** more option arg completions ([1303f8a](https://github.com/yedayak/bash-completion/commit/1303f8aba2f083d6d064225a1155fc23099f538d))
* **ssh-keygen:** update -t arg completions ([4269a90](https://github.com/yedayak/bash-completion/commit/4269a90fa4d0920c330c90a679c18e8cafb19e7b))
* **ssh-keygen:** update -Y arg completions ([a73bcaf](https://github.com/yedayak/bash-completion/commit/a73bcaf1e1ee366362d121534ce1cc8e6dece090))
* **ssh:** do not complete -P arg (tag) ([7d26a86](https://github.com/yedayak/bash-completion/commit/7d26a86f3e971739f082c1e73c45f65ea887cfd4))
* **ssh:** include proxy in -O arg completions ([fc1df1f](https://github.com/yedayak/bash-completion/commit/fc1df1f56eb6361537f4c119d170cab16349615d))
* **ssh:** more option arg (non-)completions ([33f789c](https://github.com/yedayak/bash-completion/commit/33f789c96ae35991064c9ca91dfefd23595f3c0a))
* **steampipe:** add 3rd party fallback completion loader ([aa6f0fd](https://github.com/yedayak/bash-completion/commit/aa6f0fdc3b4795d40343fb2217824302fba25f8d))
* **stern:** add 3rd party fallback completion loader ([0192486](https://github.com/yedayak/bash-completion/commit/01924865cc7883a5f912622d19bdba7b0e6ae6c3))
* **stripe:** add 3rd party fallback completion loader ([7cf1b3f](https://github.com/yedayak/bash-completion/commit/7cf1b3f4117827be36a0f462d6923d859d89c472))
* **sudo-rs,sudo.ws:** alias to sudo ([084cc68](https://github.com/yedayak/bash-completion/commit/084cc684071fcd025eae650bdf09429a8d3eb33d))
* **sudo:** more option argument (non-)completions ([379ec2d](https://github.com/yedayak/bash-completion/commit/379ec2d57c417ca49bfea3670e6fbb03e67a528f))
* **sudo:** more option argument (non-)completions ([216135e](https://github.com/yedayak/bash-completion/commit/216135ecb10457f247e33a40aa3247915ab095cc))
* **syft:** add 3rd party fallback completion loader ([44427f4](https://github.com/yedayak/bash-completion/commit/44427f4c6723ec4843b3d7352c976685f0709729))
* **syncthing:** add 3rd party fallback completion loader ([bc5dfff](https://github.com/yedayak/bash-completion/commit/bc5dfffffe4e1d5e4b7305494a7e0743da4afcd3))
* **talhelper:** add 3rd party fallback completion loader ([c6fc803](https://github.com/yedayak/bash-completion/commit/c6fc803c863a66e333290d76ffb68a13cb8abf05))
* **task:** add 3rd party fallback completion loader ([6239823](https://github.com/yedayak/bash-completion/commit/6239823d558a990fedd9050df8ca79df5a120a6f))
* **tctl:** add 3rd party fallback completion loader ([0348cbf](https://github.com/yedayak/bash-completion/commit/0348cbfcadb3be234789805798f3d0348727508f))
* **tfctl:** add 3rd party fallback completion loader ([014faa5](https://github.com/yedayak/bash-completion/commit/014faa51c77c9334ea6db26302de11ee1859c038))
* **tilt:** add 3rd party fallback completion loader ([eeeef1c](https://github.com/yedayak/bash-completion/commit/eeeef1cf717eabd627742599fe9efe8af89b9c56))
* **timoni:** add 3rd party fallback completion loader ([d51ceba](https://github.com/yedayak/bash-completion/commit/d51ceba69a504f1fe36143c83f2780bf769c02e3))
* **tldr:** add 3rd party fallback completion loader ([298700a](https://github.com/yedayak/bash-completion/commit/298700a0f34e7cd72b1c7535e0993b8d350e5c2e))
* **tmux:** add a new completion ([#1364](https://github.com/yedayak/bash-completion/issues/1364)) ([1b87ff7](https://github.com/yedayak/bash-completion/commit/1b87ff7f6c08a5ce9b89f001e70856c501034ca5))
* **tmux:** complete src/target session arguments ([18b6da4](https://github.com/yedayak/bash-completion/commit/18b6da4f58e729ea82d8f9cc49dfd7fcfd692388))
* **tmux:** complete target-session arguments ([ced59c3](https://github.com/yedayak/bash-completion/commit/ced59c38e9d01c200e6bcb706a8df497aed6ff90))
* **trash-cli:** add 3rd party fallback completion loader ([533244c](https://github.com/yedayak/bash-completion/commit/533244c7603b7a139a56549c0b3238c16995a7e7))
* **unzip,zipinfo:** Android split APK .apkm .apks .xapk ([92f558d](https://github.com/yedayak/bash-completion/commit/92f558d582c452e96872f480ebf86cc3c08f0a87))
* **unzip,zipinfo:** generate *.crx (Google Chrome Extension archives) ([#1406](https://github.com/yedayak/bash-completion/issues/1406)) ([1631952](https://github.com/yedayak/bash-completion/commit/163195233a02cf90edafc7021ac1558a8521bb20))
* **unzip,zipinfo:** recognize HarmonyOS .hap ([21cf854](https://github.com/yedayak/bash-completion/commit/21cf85495149040b6e45eebe6441fa3ceebfff69))
* **vela:** add 3rd party fallback completion loader ([34c8b32](https://github.com/yedayak/bash-completion/commit/34c8b328629eaaa280bc3fc4fbf36612d236e488))
* **velero:** add 3rd party fallback completion loader ([b058145](https://github.com/yedayak/bash-completion/commit/b058145dadee09789daa38edcb2729fa597a15a9))
* **venom:** add 3rd party fallback completion loader ([c77de6c](https://github.com/yedayak/bash-completion/commit/c77de6c214ed36707671566a4827d6db2efd7203))
* **wasmer,wasmer-headless:** add 3rd party fallback completion loader ([5986022](https://github.com/yedayak/bash-completion/commit/5986022a18a6581891b1a8aee878ec5b3b1f582c))
* **waydroid:** add 3rd party fallback completion loader ([acc800f](https://github.com/yedayak/bash-completion/commit/acc800f023ab446775c4ab1db7c77db3d2fdc739))
* **wget:** ipv6 addresses for --bind-address ([d3ff6a7](https://github.com/yedayak/bash-completion/commit/d3ff6a7081c53778529f5bad3e0846f12b29bc74))
* **xc:** add 3rd party fallback completion loader ([97d8eae](https://github.com/yedayak/bash-completion/commit/97d8eaeca4473e60b4c83ba2eefbfe1fd2df221a))
* **ytt:** add 3rd party fallback completion loader ([11cb8a6](https://github.com/yedayak/bash-completion/commit/11cb8a637e799823362be68f06bdd8e87d1b33c1))
* **zola:** add 3rd party fallback completion loader ([34b1e24](https://github.com/yedayak/bash-completion/commit/34b1e2424561b039b93976b937b5fc6d2e6e9e87))


### Bug Fixes

* **_comp_command_offset:** work around nounset ([28e19a2](https://github.com/yedayak/bash-completion/commit/28e19a2bdcc0ce2150bd807e809463e2124d01b9))
* **_comp_compgen:** clear the variable when no completions are generated ([c07bd66](https://github.com/yedayak/bash-completion/commit/c07bd661c41fc974163398ba868b22862fa8dd33))
* **_comp_compgen:** go to the original directory on compgen failure ([a5637e9](https://github.com/yedayak/bash-completion/commit/a5637e9a4793b8919da6ab4ef3aa6d8a54debf7b))
* **_comp_compgen:** go to the original directory on compgen failure ([83d92c2](https://github.com/yedayak/bash-completion/commit/83d92c225a90f923401014023d1fb5f85328a085))
* **_comp_complete_service:** fix init-script-action parsing ([#1499](https://github.com/yedayak/bash-completion/issues/1499)) ([91e075a](https://github.com/yedayak/bash-completion/commit/91e075a96d39d0234ada752a63937f63ea186eb8))
* **_comp_dequote:** set the literal value to REPLY as a fallback ([#1483](https://github.com/yedayak/bash-completion/issues/1483)) ([ed61fde](https://github.com/yedayak/bash-completion/commit/ed61fde970744e9a33f275414087fb4a050b5bfb))
* **_comp_load:** deprecate unsuffixed "completions/&lt;cmd&gt;" w/o ".bash" ([06910da](https://github.com/yedayak/bash-completion/commit/06910dab1b18cf10f4807dea93091fd81ef6531e))
* **_comp_load:** drop support for "_&lt;cmd&gt;" ([f245356](https://github.com/yedayak/bash-completion/commit/f245356d052dd506a27ae99a6d2f6b0c4fbea1ac))
* **_filedir:** always set compopt -o filenames to quote special chars ([99c599b](https://github.com/yedayak/bash-completion/commit/99c599b9d132931ffd4803f3c27e42b125f83185))
* **_filedir:** apply trailing slashes with `-f` ([b373d00](https://github.com/yedayak/bash-completion/commit/b373d0088bfb4a210b6901de49e5e210985aa5d1))
* **_umount,feh,sbopkg:** check diretory name for "_comp_compgen -C" ([c2c6c08](https://github.com/yedayak/bash-completion/commit/c2c6c08a62d8fc905739abe4e8dc8c1f37850e86))
* **_umount,feh,sbopkg:** check diretory name for `_comp_compgen -C` ([ff9e1d3](https://github.com/yedayak/bash-completion/commit/ff9e1d35b820d967242bae7163c2ae84fec22369))
* add compatibility wrapper for tail ([f6fee8a](https://github.com/yedayak/bash-completion/commit/f6fee8af6d744c1ddbcc4a947a125a897bbaaa6e))
* add miscellaneous fixes before implementing `_comp_compgen -P` ([6bd5e26](https://github.com/yedayak/bash-completion/commit/6bd5e264105fda5b16abc2287f4e5253b7124d5e))
* **apt-get,ebtables,iptables,mplayer,service:** avoid | and \| in sed ([ed64c30](https://github.com/yedayak/bash-completion/commit/ed64c30b5e77aa13cf7e0e89dab2b4ba19ea1614))
* **apt-get,gpg{,2},ipmitool,screen:** avoid \t, \r, \w in POSIX sed ([da40e7a](https://github.com/yedayak/bash-completion/commit/da40e7a85ed354a2c0ee78344164d8c8bce0c130))
* **brctl:** fix quoting of the command name ([#1296](https://github.com/yedayak/bash-completion/issues/1296)) ([3201497](https://github.com/yedayak/bash-completion/commit/32014973c96f317990693412bcf680b614b460ea))
* **ccache:** fix a wrong AWK condition ([c300c0f](https://github.com/yedayak/bash-completion/commit/c300c0fe2a994e27e679aa89a739ba1c12f25c7a))
* **cd:** Complete from . on empty CDPATH entry ([#1527](https://github.com/yedayak/bash-completion/issues/1527)) ([6f1eba6](https://github.com/yedayak/bash-completion/commit/6f1eba638f775b5729fb445d2a11278f97d79f36))
* **cd:** fix cdable_vars overwritten by another generator ([225b8ab](https://github.com/yedayak/bash-completion/commit/225b8ab422abd11bda70105a9a815791916d651a))
* **cd:** fix cdable_vars overwritten by another generator ([24bd420](https://github.com/yedayak/bash-completion/commit/24bd420adf2c06beec0672cbeac590f105792331))
* **cd:** fix the pattern matching ([b6503ba](https://github.com/yedayak/bash-completion/commit/b6503baa72f73da5304cbd13f1c0f09599080c68))
* **cd:** generate only cdable_vars containing valid directory paths ([b1374fc](https://github.com/yedayak/bash-completion/commit/b1374fc304776568f8184c72f23674ed15f376b6))
* **cd:** generate only cdable_vars containing valid directory paths ([355eb4d](https://github.com/yedayak/bash-completion/commit/355eb4d7c80522d33b64750400729d9e31388458))
* **cd:** work around bash-4.2 nounset ([45d1c93](https://github.com/yedayak/bash-completion/commit/45d1c93cd111ed5a1555b7319784dac13594380c))
* **convert:** Try calling magick, for IM7 ([4509832](https://github.com/yedayak/bash-completion/commit/4509832011d4c3df68d933d94ebb2d9e6aa97594))
* **convert:** Try calling magick, for IM7 ([ba0b8b9](https://github.com/yedayak/bash-completion/commit/ba0b8b9e65142d303c7b6545f0e5965562bfc88e))
* **fbgs,fbi:** add mandatory semicolons before "}" in POSIX sed ([288e77e](https://github.com/yedayak/bash-completion/commit/288e77ecf72a640987b6f36e504bf7259888a5cb))
* **feh:** fix "nounset" error ([e9e665e](https://github.com/yedayak/bash-completion/commit/e9e665efd7623dd9ec6d72c25c5797c497d58f65))
* **firefox:** do not split longopt argument ([5f3e5f8](https://github.com/yedayak/bash-completion/commit/5f3e5f8b939074221539750a70d5636283975717))
* fix non-POSIX sed expressions ([e999091](https://github.com/yedayak/bash-completion/commit/e999091668ee577d7b7461f0a1a4625c10c27753))
* **gnokii:** use double \\ in [...] for POSIX.1-2024 recommendation ([ab0483a](https://github.com/yedayak/bash-completion/commit/ab0483a1e1f19599aacbb4c5725bca7b2d977eda))
* **interdiff:** move to fallback for the upstream completion ([11987a4](https://github.com/yedayak/bash-completion/commit/11987a4de6ee7e4242e463336025bf7d0dde8609))
* **interfaces:** trim [@link](https://github.com/link) from completions ([#1393](https://github.com/yedayak/bash-completion/issues/1393)) ([51b009f](https://github.com/yedayak/bash-completion/commit/51b009f6a653c66454816e9bc869c40f61329764))
* **invoke-rc.d:** avoid using non-POSIX \| in sed ([db928dd](https://github.com/yedayak/bash-completion/commit/db928dd0215c714f17e71e9e0424d245cf9ad443))
* **invoke-rc.d:** fix a bug of generating existing words ([dfb903b](https://github.com/yedayak/bash-completion/commit/dfb903bfc9033d6f113493b30083d45d1b83ee1d))
* **ip:** Don't offer neighbour, only neighbor ([79fd051](https://github.com/yedayak/bash-completion/commit/79fd051907328c8c26372691f68d627c1f0e3916))
* **ipstables,ebtables:** fix filtering of chain names ([213a1d2](https://github.com/yedayak/bash-completion/commit/213a1d2904de4990ccd44344a688849d3aeaa9d8))
* **java,rsync,scp:** handle quoted space in filepaths properly ([c7be206](https://github.com/yedayak/bash-completion/commit/c7be2064a8c9dbe70608d4535626ff0bec9a2928))
* **java,rsync,ssh:** complete syntactically incomplete cur ([32515a3](https://github.com/yedayak/bash-completion/commit/32515a358e33e65045af49077771e75b201d26bc))
* **java,rsync,ssh:** complete syntactically incomplete cur ([da0df56](https://github.com/yedayak/bash-completion/commit/da0df5638b52b1f70ce469043eefc18286f76e26))
* **lilo,mutt:** remove unnecessary escaping \" in sed regexp ([b8f6ef2](https://github.com/yedayak/bash-completion/commit/b8f6ef282eaeb41af48fe5e0ecf81b274128701c))
* **lintian:** fix variable leaks ([e0e916a](https://github.com/yedayak/bash-completion/commit/e0e916abb093b3fd33d8f37ce7b4ed6c51fe6682))
* **lintian:** use compgen -X instead of sed with non-POSIX \&lt;\&gt; ([b6f34ef](https://github.com/yedayak/bash-completion/commit/b6f34ef9b83e5c682ae7a993f14936da12fd7f41))
* **make,tshark:** work around localvar_inherit ([d4ae526](https://github.com/yedayak/bash-completion/commit/d4ae52641e7e976a2c94dafeedf36b3f2d1f39cc))
* **make:** work around custom IFS ([27adc3e](https://github.com/yedayak/bash-completion/commit/27adc3e8bc4591247f5ae0533a4510a022dea2ff))
* **mdtool:** fix usage of `compgen -G` ([e623bdb](https://github.com/yedayak/bash-completion/commit/e623bdb8810a25065f542c6f7b517279d11221b7))
* **mdtool:** use `-f -X '!pat'` instead of `-G pat` ([db1d239](https://github.com/yedayak/bash-completion/commit/db1d239d1823e80bb88c21e00a4d22da71afccde))
* **mfiutil:** more link and style issues ([cbd2661](https://github.com/yedayak/bash-completion/commit/cbd266155020194ec824028fb5c0d7ac95c89474))
* miscellaneous fixes after separation of directories ([c4a8fd0](https://github.com/yedayak/bash-completion/commit/c4a8fd00cf7ccfb87a211b6ed2db3dd250c407b3))
* **openssl:** Make command extraction from help portable for BSD sed. ([6fb0827](https://github.com/yedayak/bash-completion/commit/6fb082718d86163ca2a3310d91c3491e72253cc7))
* **patch, truncate:** Get help correctly on macos ([53ab3d9](https://github.com/yedayak/bash-completion/commit/53ab3d984d3e7592b4de8af0f5ca587e23d88568))
* **patch, truncate:** Try getting help BSD style ([78379bc](https://github.com/yedayak/bash-completion/commit/78379bc1b664107be18a6c053b9d8b2f92b1efe0))
* **rcs:** avoid unexpected pathname expansion ([0fc8fff](https://github.com/yedayak/bash-completion/commit/0fc8fff69b4f0b5db44a56c94b84db450c79a4b2))
* **rsync,scp:** remove file-type marks from "ls -F" properly ([#1398](https://github.com/yedayak/bash-completion/issues/1398)) ([4bd8b58](https://github.com/yedayak/bash-completion/commit/4bd8b58a2930eb3fcced7fef89358e7c136394ad))
* **rsync,ssh,sshfs:** do not generate regular files *'\' as dirs ([040b117](https://github.com/yedayak/bash-completion/commit/040b117799ff38404f3d36a4f395a1946e85488f))
* **rsync,ssh,sshfs:** do not generate regular files *'\' as dirs ([0695e8a](https://github.com/yedayak/bash-completion/commit/0695e8a1f5dd960ffc72ffd3022c324ba718b27f))
* **rsync:** Try getting rsync arguments BSD style ([ce43661](https://github.com/yedayak/bash-completion/commit/ce43661950a7819e1019d7ecb59aac200ec51bb1))
* **rsync:** Try getting rsync arguments BSD style ([078ab1e](https://github.com/yedayak/bash-completion/commit/078ab1ea99d424a9d5b1c7886f89da986a57bce2))
* **scp,rsync:** fix misc bugs and refactor ([69c6a51](https://github.com/yedayak/bash-completion/commit/69c6a51380154d2b52999097f6cbc3e8896605d7))
* **scp:** fix a bug that `-F<prefix>[TAB]` did not complete at all ([#1396](https://github.com/yedayak/bash-completion/issues/1396)) ([3cdb549](https://github.com/yedayak/bash-completion/commit/3cdb5493d45e0e9301a56a8e8a377e0b47f81b04))
* **scp:** work around incomplete triple backslashes for remote paths ([aba62bd](https://github.com/yedayak/bash-completion/commit/aba62bd887a37bf4375d4145a3567de124b52a06))
* **shellcheck:** avoid non-POSIX \&gt; in sed regular expressions ([c0b3620](https://github.com/yedayak/bash-completion/commit/c0b3620e0b8dd082f074cfe57f761b7a9bbd0583))
* **ssh:** consider the "door" indicator in "ls -F" on Solaris ([dfa6222](https://github.com/yedayak/bash-completion/commit/dfa62226d61f221d2ad31b8fe89df05fece2bdc2))
* **sshfs:** work around bash-4.3 nounset ([2c54a45](https://github.com/yedayak/bash-completion/commit/2c54a45f5263ec108cbcb27837defc1160c1cd4a))
* **ssh:** work around localvar_inherit ([b9680a7](https://github.com/yedayak/bash-completion/commit/b9680a7d278520b4ee2fa87d965cc559efb1aa68))
* **strings:** work around nounset ([612c891](https://github.com/yedayak/bash-completion/commit/612c89157254177c6ad6928fb59caab50732b84b))
* **test/t/conftest.py:** include the output of pwd to the env check ([b6de491](https://github.com/yedayak/bash-completion/commit/b6de4915213377fb406be6fe0cfdd3b944f667f9))
* **tmux:** fix usage parsing with git master tmux ([#1381](https://github.com/yedayak/bash-completion/issues/1381)) ([d7ae352](https://github.com/yedayak/bash-completion/commit/d7ae352903b66104ca8fd89c9b98dc6b56855fa2))
* **tshark:** rename "_cmp_cmd_tshark__{ =&gt; mut_}{prefs,protocols}" ([dfacd2b](https://github.com/yedayak/bash-completion/commit/dfacd2beb74be7cdeb43d49cbeffb79f2cfe2a5a))
* **update-rc.d:** fix the usage of the X optarg ([0f47959](https://github.com/yedayak/bash-completion/commit/0f4795974607cf4ba93cb9f32b0318b65325fc31))
* **xfreerdp:** Always try /list:kbd first ([89aa18b](https://github.com/yedayak/bash-completion/commit/89aa18b15462f117c20cde5f71e109c2f616bb62))
* **xfreerdp:** try `--list-kbd` as last resort ([721fa87](https://github.com/yedayak/bash-completion/commit/721fa87c9c4ed5f2be8e890948f351f07731dcbb))
* **xfreerdp:** try `--list-kbd` as last resort ([34c1d89](https://github.com/yedayak/bash-completion/commit/34c1d89d1a3a4be31b4bef16259467b245bc563d))
* **xrandr:** remove wrong \ from character range ([cc75da2](https://github.com/yedayak/bash-completion/commit/cc75da2097ef0c2c89f6fa105872ea60426aca24))


### Performance Improvements

* **_comp_compgen_filedir_xspec:** avoid double negation `!(!(...))` ([b24305d](https://github.com/yedayak/bash-completion/commit/b24305dfebccbb2bcba66f9838704187489eaa4e))
* **_comp_delimited:** add "$prefix" only when it is non-empty ([bbb5b11](https://github.com/yedayak/bash-completion/commit/bbb5b1157744b0908eef7d38940bca3eb6a38a96))
* **filedir_xspec:** avoid double negation !(!(...)) in extglob ([c53259a](https://github.com/yedayak/bash-completion/commit/c53259ae58e545b0b7577e5d41a483f1f16c953c))
* **nmcli:** reduce uses of the "tail" command ([e3760c2](https://github.com/yedayak/bash-completion/commit/e3760c2f26ebf2507f2e1f17076bdfb7e3b99206))
* **tar:** cache the parse result of GNU tar help ([247ba7b](https://github.com/yedayak/bash-completion/commit/247ba7bb794332a42920cae796a4a9deff5179b0))
* **tar:** parse the GNU tar help on initialization ([b030e07](https://github.com/yedayak/bash-completion/commit/b030e07f1055dbc1e40b7d2f17ccd045802ff061))

## [2.20.0](https://github.com/yedayak/bash-completion/compare/2.19.0...2.20.0) (2026-03-26)
...
* **chamber:** add 3rd party fallback completion loader ([d6f2798](https://github.com/yedayak/bash-completion/commit/d6f2798960b4597ee40206e80a140cfc40e85b92))
* **changie:** add 3rd party fallback completion loader ([5268e0b](https://github.com/yedayak/bash-completion/commit/5268e0bd7700edd956ea3566216b3536cc7cbdfd))
* **clusterctl:** add 3rd party fallback completion loader ([6124044](https://github.com/yedayak/bash-completion/commit/612404438fc99954e2fa21334cbfd078fc6de44b))
* **cmctl:** add 3rd party fallback completion loader ([4dcef0b](https://github.com/yedayak/bash-completion/commit/4dcef0b6598fde5c141843ee7b3051f38d55d298))
* **colima:** add 3rd party fallback completion loader ([55a75aa](https://github.com/yedayak/bash-completion/commit/55a75aae8a21b11d65eef27e115d853a2e24819a))
* **conform:** add 3rd party fallback completion loader ([676c062](https://github.com/yedayak/bash-completion/commit/676c0629ee1f7fdba5f480387b54b708cb211b43))
* **conftest:** add 3rd party fallback completion loader ([123c8d5](https://github.com/yedayak/bash-completion/commit/123c8d599d1b818a3e775ab16854fee7ccb62f40))
* **container-structure-test:** add 3rd party fallback completion loader ([42d9241](https://github.com/yedayak/bash-completion/commit/42d9241eee14f8cbbf7e71df1ba8d7cb56badbfa))
...
## [2.19.0](https://github.com/yedayak/bash-completion/compare/2.18.0...2.19.0) (2026-03-26)
...
* associate .ogx and .oga with relevant programs ([0a13be1](https://github.com/yedayak/bash-completion/commit/0a13be1f6576ee4977552379e11157073b4e841b))
* **bombadil:** add 3rd party fallback completion loader ([90ef9a2](https://github.com/yedayak/bash-completion/commit/90ef9a215521f14e0c66dd10d530c14648e7ecf6))
* **bosh:** add 3rd party fallback completion loader ([21fcca5](https://github.com/yedayak/bash-completion/commit/21fcca5e44793cf235de1dd281e2d84ca5ee0263))
* **brave:** alias to chromium ([928c74f](https://github.com/yedayak/bash-completion/commit/928c74fc7a41e0fd1322cd6e583c693daeca76fe))
* **bsdtar:** support .apk, .ipa and .hap ([bc10b93](https://github.com/yedayak/bash-completion/commit/bc10b93e5bc16ea3c5e20d26de9eabcd9ba7d97f))
* **caddy:** add 3rd party fallback completion loader ([6b999e5](https://github.com/yedayak/bash-completion/commit/6b999e5bd6167154d54e516fe631716713356740))
* **chamber:** add 3rd party fallback completion loader ([d6f2798](https://github.com/yedayak/bash-completion/commit/d6f2798960b4597ee40206e80a140cfc40e85b92))
* **changie:** add 3rd party fallback completion loader ([5268e0b](https://github.com/yedayak/bash-completion/commit/5268e0bd7700edd956ea3566216b3536cc7cbdfd))
* **clusterctl:** add 3rd party fallback completion loader ([6124044](https://github.com/yedayak/bash-completion/commit/612404438fc99954e2fa21334cbfd078fc6de44b))
* **cmctl:** add 3rd party fallback completion loader ([4dcef0b](https://github.com/yedayak/bash-completion/commit/4dcef0b6598fde5c141843ee7b3051f38d55d298))
...
## [2.18.0](https://github.com/yedayak/bash-completion/compare/2.17.0...2.18.0) (2026-03-26)
...
* **asdf:** add 3rd-party fallback completion loader for "asdf" ([cb9303f](https://github.com/yedayak/bash-completion/commit/cb9303f5b121ea4769e20b3bb44959c4a2214661))
* associate .ogx and .oga with relevant programs ([0a13be1](https://github.com/yedayak/bash-completion/commit/0a13be1f6576ee4977552379e11157073b4e841b))
* **atmos:** add 3rd party fallback completion loader ([8796f86](https://github.com/yedayak/bash-completion/commit/8796f86938758396ae3e89c167f3dc1e834612e1))
* **bashbot:** add 3rd party fallback completion loader ([494e625](https://github.com/yedayak/bash-completion/commit/494e6251e8ab7f8a707fcdcd40255a994357d824))
* **bombadil:** add 3rd party fallback completion loader ([90ef9a2](https://github.com/yedayak/bash-completion/commit/90ef9a215521f14e0c66dd10d530c14648e7ecf6))
* **bosh:** add 3rd party fallback completion loader ([21fcca5](https://github.com/yedayak/bash-completion/commit/21fcca5e44793cf235de1dd281e2d84ca5ee0263))
* **brave:** alias to chromium ([928c74f](https://github.com/yedayak/bash-completion/commit/928c74fc7a41e0fd1322cd6e583c693daeca76fe))
* **bsdtar:** support .apk, .ipa and .hap ([bc10b93](https://github.com/yedayak/bash-completion/commit/bc10b93e5bc16ea3c5e20d26de9eabcd9ba7d97f))
